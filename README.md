...
<h3 align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=500&size=24&pause=1000&color=00C6FF&center=true&vCenter=true&width=700&lines=AI%2FML+Engineer+%7C+Research+Intern+%7C+Patent+Holder;Reinforcement+Learning+%7C+LLMs+%7C+RAG+Systems;Voice+AI+%7C+Prompt+Engineering+%7C+TTS+Systems;Building+AI+for+Healthcare+%26+Automation;Turning+Code+into+Intelligence+%26+Impact">
  </a>
</h3>
...
I'm an **AI/ML Engineer and Research Intern** passionate about building **intelligent, explainable, and impactful AI systems**. My work spans **Reinforcement Learning, Large Language Models (LLMs), Agentic RAG Systems**, **Voice AI**, and **AI for Healthcare**.

* 🎓 Final-year *B.Tech CSE (AIML)* student at *Woxsen University*
* 💼 *AI Engineering Intern @ Atomicwork* — Shipping production AI across LLMs, Voice Systems & NLP pipelines (9 PRs merged)
...
* 🎤 *Conference Presenter* — "Shock Wave-Boundary Layer Interactions in Scramjet Engines" at NCRMET-2024, GIET University
* ⚙️ Passionate about *RAG pipelines, LLM reliability, Voice AI, and AI-driven research systems*
* 🌱 Exploring *LangChain, Transformers, MLOps, Prompt Engineering, and Explainable AI (XAI)*
...
|--------|----------------------|
| **Programming & ML** | Python, TensorFlow, PyTorch, Scikit-learn, Java |
| **LLMs & NLP** | LangChain, Hugging Face, Transformers, OpenAI APIs, Prompt Engineering |
| **Voice & Speech AI** | TTS Systems, Text Normalization, Voice Customization Pipelines |
| **Deployment & Cloud** | FastAPI, Streamlit, Docker, Google Cloud, CI/CD, ArgoCD |
| **Monitoring & Testing** | Maxim (Log Verification), Unit Testing, Slack/Jarvis Integration |
| **Data & Backend** | MySQL, Flask, REST APIs, PostgreSQL, JPA/Hibernate |
...
* 🎤 **Conference Paper (NCRMET-2024):** "Shock Wave-Boundary Layer Interactions in Scramjet Engines" — presented at GIET University, Odisha
